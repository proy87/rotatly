...
(function() {
  var M, N, active_nodes_dom, animate, animated, board, check, end_time, game_completed, get_cell, get_node_and_direction, get_request, hide_element, hold_duration, hold_timer, in_animation, in_demo, is_sliding, make_move, max_date, min_date, moves, moves_made_num_dom, moves_num_dom, moves_sequence_dom, one_less_move_dom, puzzle_date_dom, restart_button, rotate, set_shareable_text, shareable_text_dom, show_element, slided_cells, start_time, table, undo, undo_button, validate, visit_time;
  ...
  set_shareable_text = function() {
    var emoji, full_text, moves_made, number, rows, text;
  ...
  document.getElementById('copy-result').addEventListener('click', function() {
    ...
    navigator.clipboard.writeText(share_text).then(function() {
      ...
      show_element(toast);
      return setTimeout(function() {
        return hide_element(toast);
      }, 2000);
    });
    return get_request(track_url, {
      game_index: game_index,
      init_time: (start_time - visit_time) / 1000,
      game_time: (end_time - start_time) / 1000,
      moves: moves.join(''),
