...
(function() {
  var M, N, active_nodes_dom, animate, animated, board, check, end_time, game_completed, get_cell, get_node_and_direction, get_request, hide_element, hold_duration, hold_timer, in_animation, in_demo, is_sliding, make_move, moves, moves_made_num_dom, moves_num_dom, moves_sequence_dom, one_less_move_dom, restart_button, rotate, show_element, slided_cells, start_time, table, undo, undo_button, validate, visit_time;
  ...
  get_request = async function(url, data) {
    var k, params, v;
    params = [];
    for (k in data) {
      v = data[k];
  ...
  a2a_config.callbacks = [
    ...
    url;
        ...
        if (moves.length) {
          ...
          rcw = new RegExp(cw_symbol,
    'g');
          rccw = new RegExp(ccw_symbol,
    'g');
          url = canonical_url + `?moves=${moves.join('').replace(rcw,
    '%E2%86%BB').replace(rccw,
    '%E2%86%BA')}`;
        } else {
          title = "Rotatly";
          url = today_url;
  ...
  animate = function(value, row, col, cw, undo = false, demo = false, callback = null) {
    var bl, br, cell, cells, finished, l, len, tl, tr, transition_callback;
    if (in_animation) {
      return;
    }
    in_animation = true;
    ...
    transition_callback = function(e) {
      var block, c, l, len, len1, m, number_of_moves, solved;
      if (e.propertyName === 'transform') {
        ...
        if (finished === cells.length) {
          ...
          for (m = 0, len1 = cells.length; m < len1; m++) {
            c = cells[m];
            c.offsetHeight;
          }
          rotate(row, col, cw);
  ...
  validate = function() {
    var current, current_col, current_row, i, l, n, next, next_col, next_row, ref;
  ...
  get_node_and_direction = function() {
    var cell, col, current_nodes, direction, elem, i, idx, j, l, len, len1, m, nn, o, possible_nodes, prev_cell, prev_col, prev_row, ref, ref1, ref2, ref3, row, v;
    possible_nodes = (function() {
      var results = [];
      for (var l = 1, ref = (N - 1) * (M - 1); 1 <= ref ? l <= ref : l >= ref; 1 <= ref ? l++ : l--){ results.push(l); }
      return results;
    }).apply(this);
    direction = [];
    for (idx = l = 0, ref1 = slided_cells.length; (0 <= ref1 ? l < ref1 : l > ref1); idx = 0 <= ref1 ? ++l : --l) {
