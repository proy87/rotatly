...
(function() {
  ...
  get_tetramino_data = function(el) {
    ...
    if (el.classList.contains('tet-O')) {
      [row_array, col_array] = [
        (function() {
          var results = [];
          for (var m = 0, ref1 = N - 1; 0 <= ref1 ? m < ref1 : m > ref1; 0 <= ref1 ? m++ : m--){ results.push(m); }
          return results;
        }).apply(this),
        (function() {
          var results = [];
          for (var m = 0, ref2 = M - 1; 0 <= ref2 ? m < ref2 : m > ref2; 0 <= ref2 ? m++ : m--){ results.push(m); }
          return results;
        }).apply(this)
      ];
      ...
      if (rotation_angle === 0) {
        ...
        [row_array, col_array] = [
          ...
          (function() {
            var results = [];
            for (var m = 0; 0 <= M ? m < M : m > M; 0 <= M ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      ...
      if (rotation_angle === 0) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref3 = N - 1; 0 <= ref3 ? m < ref3 : m > ref3; 0 <= ref3 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref4 = M - 2; 0 <= ref4 ? m < ref4 : m > ref4; 0 <= ref4 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      } else if (rotation_angle === 90) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref5 = N - 2; 0 <= ref5 ? m < ref5 : m > ref5; 0 <= ref5 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref6 = M - 1; 0 <= ref6 ? m < ref6 : m > ref6; 0 <= ref6 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      } else if (rotation_angle === 180) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref7 = N - 1; 0 <= ref7 ? m < ref7 : m > ref7; 0 <= ref7 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref8 = M - 2; 0 <= ref8 ? m < ref8 : m > ref8; 0 <= ref8 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      } else if (rotation_angle === 270) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref9 = N - 2; 0 <= ref9 ? m < ref9 : m > ref9; 0 <= ref9 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref10 = M - 1; 0 <= ref10 ? m < ref10 : m > ref10; 0 <= ref10 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      }
      ...
      if (rotation_angle === 0) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref11 = N - 1; 0 <= ref11 ? m < ref11 : m > ref11; 0 <= ref11 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref12 = M - 2; 0 <= ref12 ? m < ref12 : m > ref12; 0 <= ref12 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      } else if (rotation_angle === 90) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref13 = N - 2; 0 <= ref13 ? m < ref13 : m > ref13; 0 <= ref13 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref14 = M - 1; 0 <= ref14 ? m < ref14 : m > ref14; 0 <= ref14 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      } else if (rotation_angle === 180) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref15 = N - 1; 0 <= ref15 ? m < ref15 : m > ref15; 0 <= ref15 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref16 = M - 2; 0 <= ref16 ? m < ref16 : m > ref16; 0 <= ref16 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      } else if (rotation_angle === 270) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref17 = N - 2; 0 <= ref17 ? m < ref17 : m > ref17; 0 <= ref17 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref18 = M - 1; 0 <= ref18 ? m < ref18 : m > ref18; 0 <= ref18 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      }
      ...
      if (rotation_angle === 0) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref19 = N - 1; 0 <= ref19 ? m < ref19 : m > ref19; 0 <= ref19 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref20 = M - 2; 0 <= ref20 ? m < ref20 : m > ref20; 0 <= ref20 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      } else if (rotation_angle === 90) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref21 = N - 2; 0 <= ref21 ? m < ref21 : m > ref21; 0 <= ref21 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref22 = M - 1; 0 <= ref22 ? m < ref22 : m > ref22; 0 <= ref22 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      } else if (rotation_angle === 180) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref23 = N - 1; 0 <= ref23 ? m < ref23 : m > ref23; 0 <= ref23 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref24 = M - 2; 0 <= ref24 ? m < ref24 : m > ref24; 0 <= ref24 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      } else if (rotation_angle === 270) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref25 = N - 2; 0 <= ref25 ? m < ref25 : m > ref25; 0 <= ref25 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref26 = M - 1; 0 <= ref26 ? m < ref26 : m > ref26; 0 <= ref26 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      }
      ...
      if (rotation_angle === 0) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref27 = N - 1; 0 <= ref27 ? m < ref27 : m > ref27; 0 <= ref27 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref28 = M - 2; 0 <= ref28 ? m < ref28 : m > ref28; 0 <= ref28 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      } else if (rotation_angle === 90) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref29 = N - 2; 0 <= ref29 ? m < ref29 : m > ref29; 0 <= ref29 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref30 = M - 1; 0 <= ref30 ? m < ref30 : m > ref30; 0 <= ref30 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      } else if (rotation_angle === 180) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref31 = N - 1; 0 <= ref31 ? m < ref31 : m > ref31; 0 <= ref31 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref32 = M - 2; 0 <= ref32 ? m < ref32 : m > ref32; 0 <= ref32 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      } else if (rotation_angle === 270) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref33 = N - 2; 0 <= ref33 ? m < ref33 : m > ref33; 0 <= ref33 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref34 = M - 1; 0 <= ref34 ? m < ref34 : m > ref34; 0 <= ref34 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      }
      ...
      if (rotation_angle === 0) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref35 = N - 1; 0 <= ref35 ? m < ref35 : m > ref35; 0 <= ref35 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref36 = M - 2; 0 <= ref36 ? m < ref36 : m > ref36; 0 <= ref36 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      } else if (rotation_angle === 90) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref37 = N - 2; 0 <= ref37 ? m < ref37 : m > ref37; 0 <= ref37 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref38 = M - 1; 0 <= ref38 ? m < ref38 : m > ref38; 0 <= ref38 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      } else if (rotation_angle === 180) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref39 = N - 1; 0 <= ref39 ? m < ref39 : m > ref39; 0 <= ref39 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref40 = M - 2; 0 <= ref40 ? m < ref40 : m > ref40; 0 <= ref40 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      } else if (rotation_angle === 270) {
        [row_array, col_array] = [
          (function() {
            var results = [];
            for (var m = 0, ref41 = N - 2; 0 <= ref41 ? m < ref41 : m > ref41; 0 <= ref41 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this),
          (function() {
            var results = [];
            for (var m = 0, ref42 = M - 1; 0 <= ref42 ? m < ref42 : m > ref42; 0 <= ref42 ? m++ : m--){ results.push(m); }
            return results;
          }).apply(this)
        ];
      }
  ...
  snap_targets = function(index) {
    ...
    inner = function(x, y, interaction) {
      var c, data, el, i, idx, j, len1, len2, len3, m, o, offset_x, offset_y, outline_board_rect, p, r, ref1, ref2, ref3, table_left, table_top;
  ...
  interact('.tetramino').draggable({
    ...
    onend: function(evt) {
      var c, col, color_class, data, el, len1, m, num, number, r, ref1, row, snap, snapped;
      el = evt.target;
  ...
  set_error = function(error) {
    ...
    return setTimeout(function() {
      return window.hide_element(error_field);
    }, 5000);
  };
  ...
  document.getElementById('create-button').addEventListener('click', function() {
    ...
    board = [];
    game_dom.querySelectorAll('td').forEach(function(e) {
      var index;
